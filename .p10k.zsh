# Generated by Powerlevel10k configuration wizard on 2020-03-26 at 12:19 CDT.
...
# angled separators, sharp heads, flat tails, 2 lines, solid, no frame, darkest, sparse,
...
() {
  ...
  # prompt_last_commit() {
  #     p10k segment -re -i VCS_COMMIT_ICON -c '[[ -v VCS_STATUS_COMMIT ]]' -t '$(git reflog --skip=1 --abbrev=5 -n 1 --pretty=format:%h) » ${VCS_STATUS_COMMIT:0:5}' -f 0 -b 2
  # }
 ...
 # Previous commit icon
 typeset -g POWERLEVEL9K_VCS_NEXTCOMMIT_ICON='\u25B7'
 POWERLEVEL9K_VCS_NEXTCOMMIT_ICON=${(g::)POWERLEVEL9K_VCS_NEXTCOMMIT_ICON}
  ...
  function is_new_commit() {
    is_in_git && [[ $LAST_GIT_COMMIT != $VCS_STATUS_COMMIT ]]
  }
  ...
  function my_git_formatter() {
    ...
    local      clean='%17F' # navy foreground
    local   modified='%17F' # navy foreground
    local  untracked='%17F' # navy foreground
    local conflicted='%1F' # red foreground
    local last='%0F' # black foreground
