# Generated by Powerlevel10k configuration wizard on 2019-12-15 at 18:47 CET.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 13213.
# Wizard options: powerline, lean, time, 2 lines, dotted, no frame, dark, compact,
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local    gitmeta='%22F'   # dark green background for certain metadata
    ...
    res+="${gitmeta}@${VCS_STATUS_COMMIT[1,8]}${clean}"
